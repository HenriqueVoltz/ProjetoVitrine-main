...
<html lang="en">
    <head>
        ...
        <title>Kingdom Hearts Final Chapter Prologue</title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="../Biblioteca/ImagensBiblioteca/KhFcPSlider.jpg" alt="Kingdom Hearts Final Chapter Prologue" /></div>
                    <div class="col-md-6">
                        <h1 class="display-5 fw-bolder">Kingdom Hearts Final Chapter Prologue</h1>
                        <p class="lead">Descubra capítulos essenciais da saga Kingdom Hearts, incluindo histórias que conectam os principais jogos da franquia.</p>
                        <div class="d-flex">
                            <a class="btn btn-outline-dark flex-shrink-0" href="#" onclick="openSteamApp('2552440', 'https://store.steampowered.com/app/2552440/KINGDOM_HEARTS_HD_28_Final_Chapter_Prologue/?curator_clanid=45029091'); return false;">
